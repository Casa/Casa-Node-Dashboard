  ...
  <form class="deposit" action="">
    <div class="alert alert-status modal-card connection-details">
      ...
      <section class="modal-card-body">
        <div class="address-info">
          <div class="address-info-left">
            ...
            <qr-code :text="lnAddress.code" size="160" class="is-pulled-left"></qr-code>
            <span class="address">{{lnAddress.code}}</span>

            <a type="button" class="button cancel"
              v-clipboard:copy="lnAddress.code"
              v-clipboard:success="onCopy"
              v-clipboard:error="onError">Copy Address</a>
          </div>
          <br>
        </div>
      ...
      <footer class="modal-card-foot">
        ...
        <a v-if="lnAddress.autoGenerated" class="button is-casa" type="button" @click="editConnection()">
          Edit Connection Details
        </a>

        <a v-else class="button is-casa" type="button" @click="editConnection()">
